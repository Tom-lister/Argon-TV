import { Video, VideoGroup, VIDEOS, VideoTag, VideoType } from "./videos.js";
    ...
    if (largeItem) {
      ...
      switch (largeItemType) {
        ...
        case "groupMarathon":
          ...
          schedule.push(
            createScheduleMarathon(groupMarathonVideos, randomGroup),
          );
          break;
        case "longVideo":
      ...
      const filteredVideos = VIDEOS.filter(
        (video) => video.type !== VideoType.Update && video.length < 60 * 30,
      );
